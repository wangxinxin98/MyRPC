package com.wang.transport.zookeeper.client;
...
public class ZookeeperClientHandler extends SimpleChannelInboundHandler<RpcResponse> {
    private static final Logger logger = LoggerFactory.getLogger(ZookeeperClientHandler.class);
